...
class HomeVC: UIViewController {
    public var name = ""
       ...
       private let myImageView:UIImageView = {
           ...
           imageView.image = UIImage(named: "Wether")
           return imageView
       }()
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = .white
               ...
               bckimage.image = UIImage(named: "b1")
    ...
    override func viewDidLayoutSubviews() {
           ...
           myImageView.frame = CGRect(x: 150, y: additionalSafeAreaInsets.top + 150, width: 100, height: 100)
